...
void ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_init_function(
...
void ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_fini_function(void * message_memory)
{
  ublox_msgs__msg__NavRELPOSNED__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_member_array[15] = {
  {
    "version",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_members = {
  "ublox_msgs__msg",  // message namespace
  "NavRELPOSNED",  // message name
  15,  // number of fields
  sizeof(ublox_msgs__msg__NavRELPOSNED),
  ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_member_array,  // message members
  ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_init_function,  // function to initialize message memory (memory has to be allocated)
  ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_type_support_handle = {
  0,
  &ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_msgs, msg, NavRELPOSNED)() {
  if (!ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_type_support_handle.typesupport_identifier) {
    ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ublox_msgs__msg__NavRELPOSNED__rosidl_typesupport_introspection_c__NavRELPOSNED_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
