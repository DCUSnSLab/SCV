...
class Metaclass_AidALM(type):
    """Metaclass of message 'AidALM'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__aid_alm
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__aid_alm
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__aid_alm
            cls._TYPE_SUPPORT = module.type_support_msg__msg__aid_alm
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__aid_alm
    ...
    def CLASS_ID(self):
        ...
        return Metaclass_AidALM.__constants['CLASS_ID']

    @property
    def MESSAGE_ID(self):
        """Message constant 'MESSAGE_ID'."""
        return Metaclass_AidALM.__constants['MESSAGE_ID']


class AidALM(metaclass=Metaclass_AidALM):
    """
