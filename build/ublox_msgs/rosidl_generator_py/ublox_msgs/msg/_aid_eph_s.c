...
bool ublox_msgs__msg__aid_eph__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._aid_eph.AidEPH", full_classname_dest, 30) == 0);
  }
  ublox_msgs__msg__AidEPH * ros_message = _ros_message;
  {  // svid
...
{
  /* NOTE(esteve): Call constructor of AidEPH */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._aid_eph");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AidEPH");
