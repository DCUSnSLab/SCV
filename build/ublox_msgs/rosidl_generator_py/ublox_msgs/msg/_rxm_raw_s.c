...
bool ublox_msgs__msg__rxm_raw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._rxm_raw.RxmRAW", full_classname_dest, 30) == 0);
  }
  ublox_msgs__msg__RxmRAW * ros_message = _ros_message;
  {  // rcv_tow
    ...
    ros_message->rcv_tow = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // week
  ...
  {  // sv
    ...
    if (!ublox_msgs__msg__RxmRAWSV__Sequence__init(&(ros_message->sv), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ublox_msgs__msg__RxmRAWSV__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ublox_msgs__msg__RxmRAWSV * dest = ros_message->sv.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ublox_msgs__msg__rxm_rawsv__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of RxmRAW */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._rxm_raw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RxmRAW");
  ...
  {  // rcv_tow
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->rcv_tow);
    {
  ...
  {  // sv
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ublox_msgs__msg__rxm_rawsv__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
