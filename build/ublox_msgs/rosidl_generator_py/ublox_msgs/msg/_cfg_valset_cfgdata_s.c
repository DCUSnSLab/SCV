...
bool ublox_msgs__msg__cfg_valset_cfgdata__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._cfg_valset_cfgdata.CfgVALSETCfgdata", full_classname_dest, 51) == 0);
  }
  ublox_msgs__msg__CfgVALSETCfgdata * ros_message = _ros_message;
  {  // key
    ...
    ros_message->key = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of CfgVALSETCfgdata */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._cfg_valset_cfgdata");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CfgVALSETCfgdata");
