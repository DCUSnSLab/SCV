...
bool ublox_msgs__msg__cfg_valget__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._cfg_valget.CfgVALGET", full_classname_dest, 36) == 0);
  }
  ublox_msgs__msg__CfgVALGET * ros_message = _ros_message;
  {  // version
...
{
  /* NOTE(esteve): Call constructor of CfgVALGET */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._cfg_valget");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CfgVALGET");
