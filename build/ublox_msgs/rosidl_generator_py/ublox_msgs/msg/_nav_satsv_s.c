...
bool ublox_msgs__msg__nav_satsv__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._nav_satsv.NavSATSV", full_classname_dest, 34) == 0);
  }
  ublox_msgs__msg__NavSATSV * ros_message = _ros_message;
  {  // gnss_id
  ...
  {  // pr_res
    ...
    assert(PyLong_Check(field));
    ros_message->pr_res = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // flags
...
{
  /* NOTE(esteve): Call constructor of NavSATSV */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._nav_satsv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavSATSV");
