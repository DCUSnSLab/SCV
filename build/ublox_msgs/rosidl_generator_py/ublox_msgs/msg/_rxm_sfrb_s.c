...
bool ublox_msgs__msg__rxm_sfrb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._rxm_sfrb.RxmSFRB", full_classname_dest, 32) == 0);
  }
  ublox_msgs__msg__RxmSFRB * ros_message = _ros_message;
  {  // chn
  ...
  {  // dwrd
    ...
    }
    {
      ...
      Py_ssize_t size = 10;
      uint32_t * dest = ros_message->dwrd;
...
{
  /* NOTE(esteve): Call constructor of RxmSFRB */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._rxm_sfrb");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RxmSFRB");
  ...
  {  // dwrd
    ...
    uint32_t * src = &(ros_message->dwrd[0]);
    memcpy(dst, src, 10 * sizeof(uint32_t));
    Py_DECREF(field);
  }
