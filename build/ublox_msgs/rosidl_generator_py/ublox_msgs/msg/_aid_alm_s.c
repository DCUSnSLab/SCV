...
bool ublox_msgs__msg__aid_alm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._aid_alm.AidALM", full_classname_dest, 30) == 0);
  }
  ublox_msgs__msg__AidALM * ros_message = _ros_message;
  {  // svid
...
{
  /* NOTE(esteve): Call constructor of AidALM */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._aid_alm");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AidALM");
