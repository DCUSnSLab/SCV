...
bool ublox_msgs__msg__rxm_svsisv__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._rxm_svsisv.RxmSVSISV", full_classname_dest, 36) == 0);
  }
  ublox_msgs__msg__RxmSVSISV * ros_message = _ros_message;
  {  // svid
  ...
  {  // sv_flag
    ...
    assert(PyLong_Check(field));
    ros_message->sv_flag = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // azim
...
{
  /* NOTE(esteve): Call constructor of RxmSVSISV */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._rxm_svsisv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RxmSVSISV");
  ...
  {  // sv_flag
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->sv_flag);
    {
