...
bool ublox_msgs__msg__mon_hw6__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._mon_hw6.MonHW6", full_classname_dest, 30) == 0);
  }
  ublox_msgs__msg__MonHW6 * ros_message = _ros_message;
  {  // pin_sel
...
{
  /* NOTE(esteve): Call constructor of MonHW6 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._mon_hw6");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MonHW6");
