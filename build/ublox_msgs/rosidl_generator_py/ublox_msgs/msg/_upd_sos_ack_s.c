...
bool ublox_msgs__msg__upd_sos_ack__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._upd_sos_ack.UpdSOSAck", full_classname_dest, 37) == 0);
  }
  ublox_msgs__msg__UpdSOSAck * ros_message = _ros_message;
  {  // cmd
...
{
  /* NOTE(esteve): Call constructor of UpdSOSAck */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._upd_sos_ack");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UpdSOSAck");
