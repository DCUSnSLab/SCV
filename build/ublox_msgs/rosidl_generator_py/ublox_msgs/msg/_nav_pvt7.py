...
class Metaclass_NavPVT7(type):
    """Metaclass of message 'NavPVT7'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ublox_msgs.msg.NavPVT7')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__nav_pvt7
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__nav_pvt7
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__nav_pvt7
            cls._TYPE_SUPPORT = module.type_support_msg__msg__nav_pvt7
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__nav_pvt7
    ...
    def CLASS_ID(self):
        ...
        return Metaclass_NavPVT7.__constants['CLASS_ID']

    @property
    def MESSAGE_ID(self):
        """Message constant 'MESSAGE_ID'."""
        return Metaclass_NavPVT7.__constants['MESSAGE_ID']

    @property
    def VALID_DATE(self):
        """Message constant 'VALID_DATE'."""
        return Metaclass_NavPVT7.__constants['VALID_DATE']

    @property
    def VALID_TIME(self):
        """Message constant 'VALID_TIME'."""
        return Metaclass_NavPVT7.__constants['VALID_TIME']

    @property
    def VALID_FULLY_RESOLVED(self):
        """Message constant 'VALID_FULLY_RESOLVED'."""
        return Metaclass_NavPVT7.__constants['VALID_FULLY_RESOLVED']

    @property
    def VALID_MAG(self):
        """Message constant 'VALID_MAG'."""
        return Metaclass_NavPVT7.__constants['VALID_MAG']

    @property
    def FIX_TYPE_NO_FIX(self):
        """Message constant 'FIX_TYPE_NO_FIX'."""
        return Metaclass_NavPVT7.__constants['FIX_TYPE_NO_FIX']

    @property
    def FIX_TYPE_DEAD_RECKONING_ONLY(self):
        """Message constant 'FIX_TYPE_DEAD_RECKONING_ONLY'."""
        return Metaclass_NavPVT7.__constants['FIX_TYPE_DEAD_RECKONING_ONLY']

    @property
    def FIX_TYPE_2D(self):
        """Message constant 'FIX_TYPE_2D'."""
        return Metaclass_NavPVT7.__constants['FIX_TYPE_2D']

    @property
    def FIX_TYPE_3D(self):
        """Message constant 'FIX_TYPE_3D'."""
        return Metaclass_NavPVT7.__constants['FIX_TYPE_3D']

    @property
    def FIX_TYPE_GNSS_DEAD_RECKONING_COMBINED(self):
        """Message constant 'FIX_TYPE_GNSS_DEAD_RECKONING_COMBINED'."""
        return Metaclass_NavPVT7.__constants['FIX_TYPE_GNSS_DEAD_RECKONING_COMBINED']

    @property
    def FIX_TYPE_TIME_ONLY(self):
        """Message constant 'FIX_TYPE_TIME_ONLY'."""
        return Metaclass_NavPVT7.__constants['FIX_TYPE_TIME_ONLY']

    @property
    def FLAGS_GNSS_FIX_OK(self):
        """Message constant 'FLAGS_GNSS_FIX_OK'."""
        return Metaclass_NavPVT7.__constants['FLAGS_GNSS_FIX_OK']

    @property
    def FLAGS_DIFF_SOLN(self):
        """Message constant 'FLAGS_DIFF_SOLN'."""
        return Metaclass_NavPVT7.__constants['FLAGS_DIFF_SOLN']

    @property
    def FLAGS_PSM_MASK(self):
        """Message constant 'FLAGS_PSM_MASK'."""
        return Metaclass_NavPVT7.__constants['FLAGS_PSM_MASK']

    @property
    def PSM_OFF(self):
        """Message constant 'PSM_OFF'."""
        return Metaclass_NavPVT7.__constants['PSM_OFF']

    @property
    def PSM_ENABLED(self):
        """Message constant 'PSM_ENABLED'."""
        return Metaclass_NavPVT7.__constants['PSM_ENABLED']

    @property
    def PSM_ACQUIRED(self):
        """Message constant 'PSM_ACQUIRED'."""
        return Metaclass_NavPVT7.__constants['PSM_ACQUIRED']

    @property
    def PSM_TRACKING(self):
        """Message constant 'PSM_TRACKING'."""
        return Metaclass_NavPVT7.__constants['PSM_TRACKING']

    @property
    def PSM_POWER_OPTIMIZED_TRACKING(self):
        """Message constant 'PSM_POWER_OPTIMIZED_TRACKING'."""
        return Metaclass_NavPVT7.__constants['PSM_POWER_OPTIMIZED_TRACKING']

    @property
    def PSM_INACTIVE(self):
        """Message constant 'PSM_INACTIVE'."""
        return Metaclass_NavPVT7.__constants['PSM_INACTIVE']

    @property
    def FLAGS_HEAD_VEH_VALID(self):
        """Message constant 'FLAGS_HEAD_VEH_VALID'."""
        return Metaclass_NavPVT7.__constants['FLAGS_HEAD_VEH_VALID']

    @property
    def FLAGS_CARRIER_PHASE_MASK(self):
        """Message constant 'FLAGS_CARRIER_PHASE_MASK'."""
        return Metaclass_NavPVT7.__constants['FLAGS_CARRIER_PHASE_MASK']

    @property
    def CARRIER_PHASE_NO_SOLUTION(self):
        """Message constant 'CARRIER_PHASE_NO_SOLUTION'."""
        return Metaclass_NavPVT7.__constants['CARRIER_PHASE_NO_SOLUTION']

    @property
    def CARRIER_PHASE_FLOAT(self):
        """Message constant 'CARRIER_PHASE_FLOAT'."""
        return Metaclass_NavPVT7.__constants['CARRIER_PHASE_FLOAT']

    @property
    def CARRIER_PHASE_FIXED(self):
        """Message constant 'CARRIER_PHASE_FIXED'."""
        return Metaclass_NavPVT7.__constants['CARRIER_PHASE_FIXED']

    @property
    def FLAGS2_CONFIRMED_AVAILABLE(self):
        """Message constant 'FLAGS2_CONFIRMED_AVAILABLE'."""
        return Metaclass_NavPVT7.__constants['FLAGS2_CONFIRMED_AVAILABLE']

    @property
    def FLAGS2_CONFIRMED_DATE(self):
        """Message constant 'FLAGS2_CONFIRMED_DATE'."""
        return Metaclass_NavPVT7.__constants['FLAGS2_CONFIRMED_DATE']

    @property
    def FLAGS2_CONFIRMED_TIME(self):
        """Message constant 'FLAGS2_CONFIRMED_TIME'."""
        return Metaclass_NavPVT7.__constants['FLAGS2_CONFIRMED_TIME']


class NavPVT7(metaclass=Metaclass_NavPVT7):
    """
    Message class 'NavPVT7'.
