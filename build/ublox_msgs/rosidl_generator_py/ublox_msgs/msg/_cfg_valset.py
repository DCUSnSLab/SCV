...
class Metaclass_CfgVALSET(type):
    """Metaclass of message 'CfgVALSET'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ublox_msgs.msg.CfgVALSET')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__cfg_valset
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__cfg_valset
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__cfg_valset
            cls._TYPE_SUPPORT = module.type_support_msg__msg__cfg_valset
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__cfg_valset

            from ublox_msgs.msg import CfgVALSETCfgdata
            if CfgVALSETCfgdata.__class__._TYPE_SUPPORT is None:
                CfgVALSETCfgdata.__class__.__import_type_support__()
    ...
    def CLASS_ID(self):
        ...
        return Metaclass_CfgVALSET.__constants['CLASS_ID']

    @property
    def MESSAGE_ID(self):
        """Message constant 'MESSAGE_ID'."""
        return Metaclass_CfgVALSET.__constants['MESSAGE_ID']

    @property
    def LAYER_RAM(self):
        """Message constant 'LAYER_RAM'."""
        return Metaclass_CfgVALSET.__constants['LAYER_RAM']

    @property
    def LAYER_BBR(self):
        """Message constant 'LAYER_BBR'."""
        return Metaclass_CfgVALSET.__constants['LAYER_BBR']

    @property
    def LAYER_FLASH(self):
        """Message constant 'LAYER_FLASH'."""
        return Metaclass_CfgVALSET.__constants['LAYER_FLASH']


class CfgVALSET(metaclass=Metaclass_CfgVALSET):
    """
    Message class 'CfgVALSET'.
    ...
    _fields_and_field_types = {
        ...
        'layers': 'uint8',
        'reserved0': 'uint8[2]',
        'cfgdata': 'sequence<ublox_msgs/CfgVALSETCfgdata>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ublox_msgs', 'msg'], 'CfgVALSETCfgdata')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.cfgdata = kwargs.get('cfgdata', [])
    ...
    @builtins.property
    def cfgdata(self):
        """Message field 'cfgdata'."""
        return self._cfgdata

    @cfgdata.setter
    def cfgdata(self, value):
        if __debug__:
            from ublox_msgs.msg import CfgVALSETCfgdata
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, CfgVALSETCfgdata) for v in value) and
                 True), \
                "The 'cfgdata' field must be a set or sequence and each value of type 'CfgVALSETCfgdata'"
        self._cfgdata = value
