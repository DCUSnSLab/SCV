...
bool ublox_msgs__msg__nav_clock__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._nav_clock.NavCLOCK", full_classname_dest, 34) == 0);
  }
  ublox_msgs__msg__NavCLOCK * ros_message = _ros_message;
  {  // i_tow
...
{
  /* NOTE(esteve): Call constructor of NavCLOCK */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._nav_clock");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavCLOCK");
