...
bool ublox_msgs__msg__cfg_valdel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._cfg_valdel.CfgVALDEL", full_classname_dest, 36) == 0);
  }
  ublox_msgs__msg__CfgVALDEL * ros_message = _ros_message;
  {  // version
  ...
  {  // keys
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint32_t * dest = ros_message->keys.data;
...
{
  /* NOTE(esteve): Call constructor of CfgVALDEL */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._cfg_valdel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CfgVALDEL");
  ...
  {  // keys
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "keys");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->keys.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->keys.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->keys.size * sizeof(uint32_t));
      assert(data != NULL);
