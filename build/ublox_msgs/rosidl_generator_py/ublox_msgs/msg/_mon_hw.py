...
class Metaclass_MonHW(type):
    """Metaclass of message 'MonHW'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mon_hw
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mon_hw
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mon_hw
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mon_hw
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mon_hw
...
class MonHW(metaclass=Metaclass_MonHW):
    ...
    def __init__(self, **kwargs):
        ...
        if 'vp' not in kwargs:
            self.vp = numpy.zeros(17, dtype=numpy.uint8)
        else:
            self.vp = numpy.array(kwargs.get('vp'), dtype=numpy.uint8)
            assert self.vp.shape == (17, )
    ...
    def vp(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 17, \
                "The 'vp' numpy.ndarray() must have a size of 17"
            self._vp = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'vp' field must be a set or sequence with length 17 and each value of type 'int' and each unsigned integer in [0, 255]"
