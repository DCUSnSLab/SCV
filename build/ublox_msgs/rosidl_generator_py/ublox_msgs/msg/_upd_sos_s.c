...
bool ublox_msgs__msg__upd_sos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._upd_sos.UpdSOS", full_classname_dest, 30) == 0);
  }
  ublox_msgs__msg__UpdSOS * ros_message = _ros_message;
  {  // cmd
...
{
  /* NOTE(esteve): Call constructor of UpdSOS */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._upd_sos");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UpdSOS");
