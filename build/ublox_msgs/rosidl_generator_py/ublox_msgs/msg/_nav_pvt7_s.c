...
bool ublox_msgs__msg__nav_pvt7__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_msgs.msg._nav_pvt7.NavPVT7", full_classname_dest, 32) == 0);
  }
  ublox_msgs__msg__NavPVT7 * ros_message = _ros_message;
  {  // i_tow
...
{
  /* NOTE(esteve): Call constructor of NavPVT7 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_msgs.msg._nav_pvt7");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavPVT7");
