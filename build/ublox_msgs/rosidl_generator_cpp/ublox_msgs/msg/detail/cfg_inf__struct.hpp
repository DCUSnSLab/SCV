...
struct CfgINF_
{
  ...
  using _blocks_type =
    std::vector<ublox_msgs::msg::CfgINFBlock_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ublox_msgs::msg::CfgINFBlock_<ContainerAllocator>>>;
  _blocks_type blocks;

  // setters for named parameter idiom
  Type & set__blocks(
    const std::vector<ublox_msgs::msg::CfgINFBlock_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ublox_msgs::msg::CfgINFBlock_<ContainerAllocator>>> & _arg)
  {
    this->blocks = _arg;
    return *this;
  }
