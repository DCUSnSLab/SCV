...
#ifndef UBLOX_MSGS__MSG__DETAIL__NAV_PVT__TRAITS_HPP_
#define UBLOX_MSGS__MSG__DETAIL__NAV_PVT__TRAITS_HPP_
...
inline std::string to_yaml(const NavPVT & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const ublox_msgs::msg::NavPVT & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ublox_msgs::msg::NavPVT & msg)
{
  return ublox_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ublox_msgs::msg::NavPVT>()
{
  return "ublox_msgs::msg::NavPVT";
}

template<>
inline const char * name<ublox_msgs::msg::NavPVT>()
{
  return "ublox_msgs/msg/NavPVT";
}

template<>
struct has_fixed_size<ublox_msgs::msg::NavPVT>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<ublox_msgs::msg::NavPVT>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<ublox_msgs::msg::NavPVT>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // UBLOX_MSGS__MSG__DETAIL__NAV_PVT__TRAITS_HPP_
