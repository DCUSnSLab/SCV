...
inline std::string to_yaml(const MonHW6 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const ublox_msgs::msg::MonHW6 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ublox_msgs::msg::MonHW6 & msg)
{
