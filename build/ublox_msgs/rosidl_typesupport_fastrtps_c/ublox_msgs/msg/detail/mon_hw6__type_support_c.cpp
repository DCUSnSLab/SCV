...
#include "ublox_msgs/msg/detail/mon_hw6__rosidl_typesupport_fastrtps_c.h"
...
using _MonHW6__ros_msg_type = ublox_msgs__msg__MonHW6;

static bool _MonHW6__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MonHW6__ros_msg_type * ros_message = static_cast<const _MonHW6__ros_msg_type *>(untyped_ros_message);
  // Field name: pin_sel
  {
...
static bool _MonHW6__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MonHW6__ros_msg_type * ros_message = static_cast<_MonHW6__ros_msg_type *>(untyped_ros_message);
  // Field name: pin_sel
  {
    cdr >> ros_message->pin_sel;
  }
...
size_t get_serialized_size_ublox_msgs__msg__MonHW6(
  const void * untyped_ros_message,
...
static uint32_t _MonHW6__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ublox_msgs__msg__MonHW6(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_ublox_msgs__msg__MonHW6(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs__msg__MonHW6;
    is_plain =
      (
...
static size_t _MonHW6__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ublox_msgs__msg__MonHW6(
...
static message_type_support_callbacks_t __callbacks_MonHW6 = {
  "ublox_msgs::msg",
  "MonHW6",
  _MonHW6__cdr_serialize,
  _MonHW6__cdr_deserialize,
  _MonHW6__get_serialized_size,
  _MonHW6__max_serialized_size
};

static rosidl_message_type_support_t _MonHW6__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ublox_msgs, msg, MonHW6)() {
  return &_MonHW6__type_support;
}
