...
#include "ublox_msgs/msg/detail/nav_dgpssv__rosidl_typesupport_fastrtps_c.h"
...
using _NavDGPSSV__ros_msg_type = ublox_msgs__msg__NavDGPSSV;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NavDGPSSV__ros_msg_type * ros_message = static_cast<const _NavDGPSSV__ros_msg_type *>(untyped_ros_message);
  // Field name: svid
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NavDGPSSV__ros_msg_type * ros_message = static_cast<_NavDGPSSV__ros_msg_type *>(untyped_ros_message);
  // Field name: svid
  {
    cdr >> ros_message->svid;
  }
...
static uint32_t _NavDGPSSV__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ublox_msgs__msg__NavDGPSSV(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs__msg__NavDGPSSV;
    is_plain =
      (
...
static size_t _NavDGPSSV__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ublox_msgs__msg__NavDGPSSV(
...
static message_type_support_callbacks_t __callbacks_NavDGPSSV = {
  "ublox_msgs::msg",
  "NavDGPSSV",
