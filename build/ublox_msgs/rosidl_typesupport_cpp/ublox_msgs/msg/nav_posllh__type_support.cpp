...
static const _NavPOSLLH_type_support_symbol_names_t _NavPOSLLH_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, NavPOSLLH)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ublox_msgs, msg, NavPOSLLH)),
  }
};
...
{
  return &::ublox_msgs::msg::rosidl_typesupport_cpp::NavPOSLLH_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ublox_msgs, msg, NavPOSLLH)() {
  return get_message_type_support_handle<ublox_msgs::msg::NavPOSLLH>();
}
