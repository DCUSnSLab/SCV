...
ublox_msgs__msg__RxmALM__init(ublox_msgs__msg__RxmALM * msg)
{
  ...
  if (!rosidl_runtime_c__uint32__Sequence__init(&msg->dwrd, 0)) {
    ublox_msgs__msg__RxmALM__fini(msg);
    return false;
  }
  return true;
}
...
ublox_msgs__msg__RxmALM__create()
{
  ...
  ublox_msgs__msg__RxmALM * msg = (ublox_msgs__msg__RxmALM *)allocator.allocate(sizeof(ublox_msgs__msg__RxmALM), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ublox_msgs__msg__RxmALM));
  bool success = ublox_msgs__msg__RxmALM__init(msg);
  if (!success) {
...
ublox_msgs__msg__RxmALM__Sequence__init(ublox_msgs__msg__RxmALM__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ublox_msgs__msg__RxmALM * data = NULL;

  if (size) {
    data = (ublox_msgs__msg__RxmALM *)allocator.zero_allocate(size, sizeof(ublox_msgs__msg__RxmALM), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ublox_msgs__msg__RxmALM__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ublox_msgs__msg__RxmALM__fini(&data[i - 1]);
      }
...
ublox_msgs__msg__RxmALM__Sequence__fini(ublox_msgs__msg__RxmALM__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ublox_msgs__msg__RxmALM__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ublox_msgs__msg__RxmALM__Sequence * array = (ublox_msgs__msg__RxmALM__Sequence *)allocator.allocate(sizeof(ublox_msgs__msg__RxmALM__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ublox_msgs__msg__RxmALM__Sequence__init(array, size);
  if (!success) {
...
ublox_msgs__msg__RxmALM__Sequence__destroy(ublox_msgs__msg__RxmALM__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ublox_msgs__msg__RxmALM__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ublox_msgs__msg__RxmALM__Sequence__are_equal(const ublox_msgs__msg__RxmALM__Sequence * lhs, const ublox_msgs__msg__RxmALM__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ublox_msgs__msg__RxmALM__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ublox_msgs__msg__RxmALM__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ublox_msgs__msg__RxmALM);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ublox_msgs__msg__RxmALM * data =
      (ublox_msgs__msg__RxmALM *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ublox_msgs__msg__RxmALM__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ublox_msgs__msg__RxmALM__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ublox_msgs__msg__RxmALM__copy(
