...
#ifndef UBLOX_MSGS__MSG__DETAIL__NAV_PVT__STRUCT_H_
#define UBLOX_MSGS__MSG__DETAIL__NAV_PVT__STRUCT_H_
...
enum
{
  ublox_msgs__msg__NavPVT__CLASS_ID = 1
};

/// Constant 'MESSAGE_ID'.
enum
{
  ublox_msgs__msg__NavPVT__MESSAGE_ID = 7
};
...
enum
{
  ublox_msgs__msg__NavPVT__VALID_DATE = 1
};
...
enum
{
  ublox_msgs__msg__NavPVT__VALID_TIME = 2
};
...
enum
{
  ublox_msgs__msg__NavPVT__VALID_FULLY_RESOLVED = 4
};
...
enum
{
  ublox_msgs__msg__NavPVT__VALID_MAG = 8
};

/// Constant 'FIX_TYPE_NO_FIX'.
enum
{
  ublox_msgs__msg__NavPVT__FIX_TYPE_NO_FIX = 0
};

/// Constant 'FIX_TYPE_DEAD_RECKONING_ONLY'.
enum
{
  ublox_msgs__msg__NavPVT__FIX_TYPE_DEAD_RECKONING_ONLY = 1
};
...
enum
{
  ublox_msgs__msg__NavPVT__FIX_TYPE_2D = 2
};

/// Constant 'FIX_TYPE_3D'.
enum
{
  ublox_msgs__msg__NavPVT__FIX_TYPE_3D = 3
};
...
enum
{
  ublox_msgs__msg__NavPVT__FIX_TYPE_GNSS_DEAD_RECKONING_COMBINED = 4
};
...
enum
{
  ublox_msgs__msg__NavPVT__FIX_TYPE_TIME_ONLY = 5
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS_GNSS_FIX_OK = 1
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS_DIFF_SOLN = 2
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS_PSM_MASK = 28
};
...
enum
{
  ublox_msgs__msg__NavPVT__PSM_OFF = 0
};
...
enum
{
  ublox_msgs__msg__NavPVT__PSM_ENABLED = 4
};
...
enum
{
  ublox_msgs__msg__NavPVT__PSM_ACQUIRED = 8
};
...
enum
{
  ublox_msgs__msg__NavPVT__PSM_TRACKING = 12
};
...
enum
{
  ublox_msgs__msg__NavPVT__PSM_POWER_OPTIMIZED_TRACKING = 16
};
...
enum
{
  ublox_msgs__msg__NavPVT__PSM_INACTIVE = 20
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS_HEAD_VEH_VALID = 32
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS_CARRIER_PHASE_MASK = 192
};
...
enum
{
  ublox_msgs__msg__NavPVT__CARRIER_PHASE_NO_SOLUTION = 0
};
...
enum
{
  ublox_msgs__msg__NavPVT__CARRIER_PHASE_FLOAT = 64
};
...
enum
{
  ublox_msgs__msg__NavPVT__CARRIER_PHASE_FIXED = 128
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS2_CONFIRMED_AVAILABLE = 32
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS2_CONFIRMED_DATE = 64
};
...
enum
{
  ublox_msgs__msg__NavPVT__FLAGS2_CONFIRMED_TIME = 128
};

/// Struct defined in msg/NavPVT in the package ublox_msgs.
/**
  * NAV-PVT (0x01 0x07)
 ...
 */
typedef struct ublox_msgs__msg__NavPVT
{
...
// Struct for a sequence of ublox_msgs__msg__NavPVT.
typedef struct ublox_msgs__msg__NavPVT__Sequence
{
...
#endif  // UBLOX_MSGS__MSG__DETAIL__NAV_PVT__STRUCT_H_
