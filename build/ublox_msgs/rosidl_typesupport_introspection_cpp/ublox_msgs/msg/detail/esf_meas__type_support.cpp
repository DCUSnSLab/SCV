...
void fetch_function__EsfMEAS__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint32_t *>(
    get_const_function__EsfMEAS__data(untyped_member, index));
  auto & value = *reinterpret_cast<uint32_t *>(untyped_value);
  value = item;
}

void assign_function__EsfMEAS__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint32_t *>(
    get_function__EsfMEAS__data(untyped_member, index));
...
void fetch_function__EsfMEAS__calib_t_tag(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint32_t *>(
    get_const_function__EsfMEAS__calib_t_tag(untyped_member, index));
  auto & value = *reinterpret_cast<uint32_t *>(untyped_value);
  value = item;
}

void assign_function__EsfMEAS__calib_t_tag(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint32_t *>(
    get_function__EsfMEAS__calib_t_tag(untyped_member, index));
  const auto & value = *reinterpret_cast<const uint32_t *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EsfMEAS_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__EsfMEAS__data,  // fetch(index, &value) function pointer
    assign_function__EsfMEAS__data,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__EsfMEAS__calib_t_tag,  // fetch(index, &value) function pointer
    assign_function__EsfMEAS__calib_t_tag,  // assign(index, value) function pointer
