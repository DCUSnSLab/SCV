...
#include "ublox_msgs/msg/detail/mon_gnss__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_msgs::msg::MonGNSS & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs::msg::MonGNSS & ros_message)
{
  // Member: version
  cdr >> ros_message.version;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs::msg::MonGNSS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::MonGNSS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_msgs::msg::MonGNSS *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MonGNSS__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::MonGNSS *>(
...
static size_t _MonGNSS__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MonGNSS(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MonGNSS__callbacks = {
  "ublox_msgs::msg",
  "MonGNSS",
...
static rosidl_message_type_support_t _MonGNSS__handle = {
...
{
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_MonGNSS__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, MonGNSS)() {
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_MonGNSS__handle;
}
