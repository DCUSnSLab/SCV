...
#include "ublox_msgs/msg/detail/cfg_prt__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_msgs::msg::CfgPRT & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs::msg::CfgPRT & ros_message)
{
  // Member: port_id
  cdr >> ros_message.port_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs::msg::CfgPRT;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::CfgPRT *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_msgs::msg::CfgPRT *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CfgPRT__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::CfgPRT *>(
...
static size_t _CfgPRT__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CfgPRT(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CfgPRT__callbacks = {
  "ublox_msgs::msg",
  "CfgPRT",
...
static rosidl_message_type_support_t _CfgPRT__handle = {
...
{
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_CfgPRT__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, CfgPRT)() {
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_CfgPRT__handle;
}
