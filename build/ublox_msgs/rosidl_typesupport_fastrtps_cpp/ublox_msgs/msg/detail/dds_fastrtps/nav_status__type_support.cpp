...
#include "ublox_msgs/msg/detail/nav_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_msgs::msg::NavSTATUS & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs::msg::NavSTATUS & ros_message)
{
  // Member: i_tow
  cdr >> ros_message.i_tow;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs::msg::NavSTATUS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::NavSTATUS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_msgs::msg::NavSTATUS *>(
    untyped_ros_message);
...
{
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_NavSTATUS__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, NavSTATUS)() {
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_NavSTATUS__handle;
}
