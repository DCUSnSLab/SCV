...
#include "ublox_msgs/msg/detail/nav_pvt7__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_msgs::msg::NavPVT7 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs::msg::NavPVT7 & ros_message)
{
  // Member: i_tow
  cdr >> ros_message.i_tow;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs::msg::NavPVT7;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::NavPVT7 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_msgs::msg::NavPVT7 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NavPVT7__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::NavPVT7 *>(
...
static size_t _NavPVT7__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NavPVT7(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NavPVT7__callbacks = {
  "ublox_msgs::msg",
  "NavPVT7",
...
static rosidl_message_type_support_t _NavPVT7__handle = {
...
{
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_NavPVT7__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, NavPVT7)() {
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_NavPVT7__handle;
}
