...
#include "ublox_msgs/msg/detail/nav_svin__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_msgs::msg::NavSVIN & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs::msg::NavSVIN & ros_message)
{
  // Member: version
  cdr >> ros_message.version;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs::msg::NavSVIN;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::NavSVIN *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_msgs::msg::NavSVIN *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NavSVIN__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::NavSVIN *>(
...
static size_t _NavSVIN__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NavSVIN(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NavSVIN__callbacks = {
  "ublox_msgs::msg",
  "NavSVIN",
...
static rosidl_message_type_support_t _NavSVIN__handle = {
...
{
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_NavSVIN__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, NavSVIN)() {
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_NavSVIN__handle;
}
