...
#include "ublox_msgs/msg/detail/mon_hw6__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_msgs::msg::MonHW6 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs::msg::MonHW6 & ros_message)
{
  // Member: pin_sel
  cdr >> ros_message.pin_sel;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_msgs::msg::MonHW6;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::MonHW6 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_msgs::msg::MonHW6 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MonHW6__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_msgs::msg::MonHW6 *>(
...
static size_t _MonHW6__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MonHW6(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MonHW6__callbacks = {
  "ublox_msgs::msg",
  "MonHW6",
...
static rosidl_message_type_support_t _MonHW6__handle = {
...
{
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_MonHW6__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_msgs, msg, MonHW6)() {
  return &ublox_msgs::msg::typesupport_fastrtps_cpp::_MonHW6__handle;
}
