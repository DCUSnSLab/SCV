...
#define NODE_MAIN_LOGGER_NAME "usb_cam_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libusb_cam_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<usb_cam::UsbCamNode>";
