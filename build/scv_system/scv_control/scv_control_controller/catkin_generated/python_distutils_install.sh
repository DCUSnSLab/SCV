...
echo_and_run cd "/home/dong/Development/SCV/src/scv_system/scv_control/scv_control_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dong/Development/SCV/src/scv_system/scv_control/scv_control_controller/setup.py" \
     \
    build --build-base "/home/dong/Development/SCV/build/scv_system/scv_control/scv_control_controller" \
    install \
    --root="${DESTDIR-/}" \
