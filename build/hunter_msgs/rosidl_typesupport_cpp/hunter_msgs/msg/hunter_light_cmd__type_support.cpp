...
static const _HunterLightCmd_type_support_symbol_names_t _HunterLightCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hunter_msgs, msg, HunterLightCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hunter_msgs, msg, HunterLightCmd)),
  }
};
...
{
  return &::hunter_msgs::msg::rosidl_typesupport_cpp::HunterLightCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hunter_msgs, msg, HunterLightCmd)() {
  return get_message_type_support_handle<hunter_msgs::msg::HunterLightCmd>();
}
