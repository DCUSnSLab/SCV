...
static const _HunterRCState_type_support_symbol_names_t _HunterRCState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hunter_msgs, msg, HunterRCState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hunter_msgs, msg, HunterRCState)),
  }
};
...
{
  return &::hunter_msgs::msg::rosidl_typesupport_cpp::HunterRCState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hunter_msgs, msg, HunterRCState)() {
  return get_message_type_support_handle<hunter_msgs::msg::HunterRCState>();
}
