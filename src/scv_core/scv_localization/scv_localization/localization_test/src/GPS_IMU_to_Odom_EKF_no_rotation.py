...
class IMUGPSToOdometry:
    def __init__(self):
        ...
        self.last_gps_heading_reversed = None  # (여기서는 단순히 사용)
        ...
        self.reverse_driving = False  # 후진 상태
    ...
    def hunter_status_callback(self, msg):
        ...
        self.reverse_driving = (self.current_speed < -0.1)
